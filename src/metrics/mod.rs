...
impl Metrics {
    ...
    fn snapshot(&self) -> MetricsSnapshot {
        MetricsSnapshot {
            ...
            tips_sol:        self.total_tips_paid_lamports.load(Ordering::Relaxed) as f64 / 1e9,
            priority_fees_sol: self.total_priority_fees_lamports.load(Ordering::Relaxed) as f64 / 1e9,
